...
router.put('/adoptCat/:catId', userController.allowIfLoggedin, userController.allowRoles('supervisor', 'admin'), adminController.deprecatedAdoptCat);
...
router.get('/adoptions', userController.allowIfLoggedin, userController.allowRoles('supervisor', 'admin'), adoptionController.getAdoptions);

router.patch('/adoptions/:requestId/decision', userController.allowIfLoggedin, userController.allowRoles('supervisor', 'admin'), adoptionController.decideAdoption);
